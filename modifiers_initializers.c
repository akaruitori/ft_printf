...
/*   Updated: 2019/08/27 15:42:42 by dtimeon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_arg_type			*initialize_arg_type(void)
{
	...
	new_arg_type = (t_arg_type *)malloc(sizeof(t_arg_type));
...
t_flags				*initialize_flags(void)
{
	...
	new_flags = (t_flags *)malloc(sizeof(t_flags));
	new_flags->space = 0;
	new_flags->plus = 0;
...
t_width				*initialize_width(void)
{
	...
	new_width = (t_width *)malloc(sizeof(t_width));
...
t_modifier			*initialize_modifier(void)
{
	...
	new_modifier = (t_modifier *)malloc(sizeof(t_modifier));
